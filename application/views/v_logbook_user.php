		...
		<table>
			...
			<div class="container">
				<?php
					...
					$date2="";
				?>	
					<form class="form-inline" action="<?php echo site_url('c_logbook/search_datex');?>" method = "post">
						...
						<button type="submit" class="btn btn-primary" style="font-size: 12px; background-color: #205182;"><i class="fa fa-search"></i> Search</button>
					</form>
				<center >
					<br>
						...
						<tbody>
							<?php
	                          ...
	                          foreach ($datas as $tanggal => $data) {
	                            echo "<tr style='background-color: #43688c; color: white; text-align: center;'>
	                                ...
	                                for ($i = 0; $i < $count; $i++){
	                                  ...
	                                  ?>
	                                  <td width="70px"><a href="<?php echo base_url(); ?>index.php/c_logbook/data_id_user/<?php echo $data['id'][$i];?>" class="btn btn-info btn-xs" style="font-size: 12px;"><i class="fa fa-info"></i> Detail</a>
									 </a>
	                                  </td>
	                                  <?php         
	                                   echo "</tr>";
					...
					<a href="<?php echo base_url(); ?>index.php/c_login/keluar" class="btn btn-primary" style="font-size: 12px; background-color: #205182;"><i class="fa fa-sign-out"></i>Log Out</a>
					<br>
					<br>
